...
require_once __DIR__ . '/../models/admin_layout_view_model.php';

/**
 * Usage: Load only the model file required by the requested admin action.
 * Referenced by: corebb_admin_route_model().
 */
function corebb_admin_route_require_model(string $act): void
{
    $files = [
        '' => 'admin_dashboard_view_model.php',
        'version_history' => 'admin_version_history_view_model.php',
        'edit_settings' => 'admin_settings_view_model.php',
        'mail_services' => 'admin_mail_view_model.php',
        'auth_settings' => 'admin_auth_settings_view_model.php',
        'administrator_tools' => 'admin_maintenance_view_model.php',
        'database_tools' => 'admin_maintenance_view_model.php',
        'db_schema_deploy' => 'admin_db_schema_deploy_view_model.php',
        'updates' => 'admin_updates_view_model.php',
        'api_explorer' => 'admin_api_explorer_view_model.php',
        'forum_sim' => 'admin_forum_sim_view_model.php',
        'edit_tos' => 'admin_content_view_model.php',
        'edit_style' => 'admin_content_view_model.php',
        'edit_rights' => 'admin_user_tools_view_model.php',
        'change_user_password' => 'admin_user_tools_view_model.php',
        'add_user' => 'admin_user_tools_view_model.php',
        'view_message' => 'admin_user_tools_view_model.php',
        'global_message' => 'admin_global_messages_view_model.php',
        'edit_global_message' => 'admin_global_messages_view_model.php',
        'remove_global_message' => 'admin_global_messages_view_model.php',
        'manage_icons' => 'admin_icons_view_model.php',
        'moderation' => 'admin_moderation_view_model.php',
        'moderate_message' => 'admin_moderation_view_model.php',
        'admin_notes' => 'admin_user_notes_view_model.php',
        'action_log' => 'admin_action_log_view_model.php',
        'user_pages' => 'admin_user_pages_view_model.php',
        'user_ip_check' => 'admin_user_ip_check_view_model.php',
        'host_lookup' => 'admin_host_lookup_view_model.php',
        'mod_requests' => 'admin_mod_requests_view_model.php',
        'deleted_posts' => 'admin_deleted_posts_view_model.php',
        'spam_ratings' => 'admin_spam_ratings_view_model.php',
        'pm_reports' => 'admin_pm_moderation_view_model.php',
        'pm_history' => 'admin_pm_moderation_view_model.php',
        'contact_mods' => 'admin_contact_mods_view_model.php',
        'latest_users' => 'admin_latest_users_view_model.php',
        'assign_title' => 'admin_assign_title_view_model.php',
        'edit_profile' => 'admin_edit_profile_view_model.php',
        'user_appearance' => 'user_appearance_view_model.php',
        'manageboards' => 'admin_boards_view_model.php',
        'movebrd' => 'admin_boards_view_model.php',
        'movecat' => 'admin_boards_view_model.php',
        'add_category' => 'admin_boards_view_model.php',
        'delete_category' => 'admin_boards_view_model.php',
        'manageboards_cat' => 'admin_boards_view_model.php',
        'addboard' => 'admin_boards_view_model.php',
        'modifyboard' => 'admin_boards_view_model.php',
    ];

    require_once __DIR__ . '/../models/' . ($files[$act] ?? $files['']);
}
...
{
    corebb_admin_route_require_model((string)($route['act'] ?? ''));

    $handler = $route['handler'] ?? null;
    if (!is_callable($handler)) {
        corebb_admin_route_require_model('');
