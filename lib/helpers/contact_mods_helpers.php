 ...
 * Referenced by: admin layout and lib/models/layout_view_model.php.
 *
...
{
    return corebb_security_named_token('corebb_contact_mods_token');
}
...
{
    return corebb_security_named_token_valid('corebb_contact_mods_token', $post, 'contact_mods_token');
}
