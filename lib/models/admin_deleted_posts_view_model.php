...
{
    return corebb_security_named_token('admin_deleted_posts_token');
}
...
{
    return corebb_security_named_token_valid('admin_deleted_posts_token', $post, 'admin_deleted_posts_token');
}
