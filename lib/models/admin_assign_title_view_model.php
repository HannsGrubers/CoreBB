...
{
    return corebb_security_named_token('admin_assign_title_token');
}
...
{
    return corebb_security_named_token_valid('admin_assign_title_token', $post, 'admin_assign_title_token');
}
