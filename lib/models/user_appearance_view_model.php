...
{
    return corebb_security_named_token('corebb_user_appearance_token');
}
...
{
    return corebb_security_named_token_valid('corebb_user_appearance_token', $post, 'user_appearance_token');
}
