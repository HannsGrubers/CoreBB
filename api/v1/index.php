...
corebb_api_error('not_found', 'Unknown API endpoint.', 404, [
    'available' => [
        ...
        '/api/v1/pm/read',
        '/api/v1/pm/sent',
        '/api/v1/pm/messages/{id}?folder={inbox|read|sent}',
        'POST /api/v1/pm/send',
        'POST /api/v1/pm/messages/{id}/read',
        'POST /api/v1/mod/topics/{id}/lock',
        'POST /api/v1/mod/topics/{id}/unlock',
        'POST /api/v1/mod/posts/{id}/remove',
        'POST /api/v1/mod/posts/{id}/restore',
        'POST /api/v1/mod/users/{id}/ban',
        'POST /api/v1/mod/users/{id}/unban',
        'POST /api/v1/polls/{topicId}/vote',
        '/api/v1/post/reply/{threadId}?board_id={boardId}&quote_id={postId}',
        'POST /api/v1/post/reply',
        '/api/v1/post/new/{boardId}',
        'POST /api/v1/post/new',
        '/api/v1/post/edit/{postId}',
